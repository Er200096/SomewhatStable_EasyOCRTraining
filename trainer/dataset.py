    ...
    def __init__(self, root, opt):
        ...
        if self.opt.data_filtering_off:
            ...
            for index in range(self.nSamples):
                ...
                label = str(label) # Casting the numbers as a string (just in case)
                ...
                #     continue
                if re.search(out_of_char, label): # Given all the file_names are numbers, we dont need to the lower() function
                    continue
